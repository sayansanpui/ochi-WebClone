...
import contentImage01 from '../assets/logo001.svg';
import contentImage02 from '../assets/logo002.svg';
import contentImage03 from '../assets/logo003.png';
            ...
            <div className='px-[4rem] flex justify-center items-center gap-[1rem] mt-[7rem]'>
                <div className='cardcontainer h-[50vh] w-1/2'>
                    <div className="card relative rounded-xl w-full h-full bg-[#004D43] flex items-center justify-center">
                        <img className='w-36' src={contentImage01} alt="" />
                ...
                <div className='cardcontainer flex gap-[1rem] w-1/2 h-[50vh]'>
                    <div className="card relative rounded-xl w-1/2 h-full bg-[#212121] flex items-center justify-center">
                        <img className='w-36' src={contentImage02} alt="" />
                    ...
                    <div className="card relative rounded-xl w-1/2 h-full bg-[#212121] flex items-center justify-center">
                        <img className='w-24' src={contentImage03} alt="" />
