                            ...
                            <div className='w-fit flex items-end overflow-hidden'>
                                {index === 1 && (
                                    <motion.div
                                        ...
                                        className='mr-[0.9vw] w-[9vw] rounded-lg h-[5.7vw] -top-[0.3vw] relative bg-[url("https://github.com/sayansanpui/ochi-WebClone/blob/main/public/content-image01.jpg?raw=true")] bg-cover'
                                    ></motion.div>
                                )}
