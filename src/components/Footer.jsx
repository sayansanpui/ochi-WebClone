...
export const Footer = () => {
    return (
        <div className=' data-scroll data-scroll-section data-scroll-speed="-.8" w-full h-screen px-[4rem] pt-[75px] pb-[75px] bg-[#f1f1f1] flex gap-[1rem]'>
            <div className='w-1/2 h-full flex flex-col justify-between'>
                <div className='hFont1 leading-[.75]'>
                    <h1 className=' text-[9rem] uppercase'>Eye-</h1>
                    <h1 className=' text-[9rem] uppercase'>Opening</h1>
                </div>
            ...
            <div className='w-1/2 h-full flex flex-col justify-between'>
                <div className='hFont1 leading-[.75]'>
                    <h1 className=' text-[9rem] uppercase'>presentations</h1>
                </div>
                <div className='pFont2 text-[#202020] text-[1.2rem]'>
                    <p class="mb-4">S:</p>
                    <ul class="social-list leading-[1.7rem] social-list--default">
                        <li className='cursor-pointer underline'>Instagram</li>
                        <li className='cursor-pointer underline'>Behance</li>
                        <li className='cursor-pointer underline'>Facebook</li>
                        <li className='cursor-pointer underline'>Linkedin</li>
                    </ul>
                </div>
                <div>
                    <div className='pFont2 text-[#202020] text-[1.2rem] flex items-center justify-between'>
                        <div>
                            <p class="mb-4">L:</p>
                            <ul class="social-list leading-[1.7rem] social-list--default mb-3">
                                <li className='cursor-pointer underline'>202-1965 W 4th Ave</li>
                                <li className='cursor-pointer underline mb-5'>Vancouver, Canada</li>
                                <li className='cursor-pointer underline'>30 Chukarina St</li>
                                <li className='cursor-pointer underline mb-10'>Lviv, Ukraine</li>
                            </ul>
                            <p class="mb-4">E:</p>
                            <ul class="social-list leading-[1.7rem] social-list--default">
                                <li className='cursor-pointer underline'>hello@ochi.design</li>
                            </ul>
                        </div>
                        <div className='pFont2 text-[#202020] text-[1.2rem] mr-[2rem]'>
                            <p class="mb-4">M:</p>
                            <ul class="social-list leading-[1.7rem] social-list--default">
                                <li className='cursor-pointer underline'>Home</li>
                                <li className='cursor-pointer underline'>Services</li>
                                <li className='cursor-pointer underline'>Our Services</li>
                                <li className='cursor-pointer underline'>About Us</li>
                                <li className='cursor-pointer underline'>Insights</li>
                                <li className='cursor-pointer underline'>Contact us</li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div className='flex items-center justify-between pFont2 text-[#b2b2b2] text-[1.2rem]'>
